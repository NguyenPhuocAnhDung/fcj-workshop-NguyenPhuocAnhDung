...
* Research and practice Amazon FSx for Windows File Server.
* Learn and deploy AWS Web Application Firewall (WAF).
* Practice IAM Permission Boundary to restrict user permissions and enhance system security.
...
* Understood the architecture and usage of Amazon FSx for Windows File Server.
* Successfully deployed AWS WAF to protect web applications.
* Successfully practiced IAM Permission Boundary to restrict user access.
